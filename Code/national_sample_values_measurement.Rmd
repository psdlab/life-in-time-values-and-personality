...
all_waves_scored <- bind_rows(
  list(`1` = bind_cols(pompit(as_data_frame(wave1_scored$scores), 1, 5), 
                       pompit(as_data_frame(wave1_scored_mvi$scores), 1, 9)),
       `2` = bind_cols(pompit(as_data_frame(wave2_scored$scores), 1, 5), 
                       pompit(as_data_frame(wave2_scored_mvi$scores), 1, 9)),
       `3` = bind_cols(pompit(as_data_frame(wave3_scored$scores), 1, 5), 
                       pompit(as_data_frame(wave3_scored_mvi$scores), 1, 9)),
       `4` = bind_cols(pompit(as_data_frame(wave4_scored$scores), 1, 5), 
...
nullius <- lapply(names(vVarNames), function(var){
  print(ggplot2::ggplot(
    ...
    ggplot2::coord_cartesian(ylim = c(1, ifelse(var == 'mvi', 9, 5))) + 
